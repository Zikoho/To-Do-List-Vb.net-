...
Public Class Frmlist3
    ...
    Private Sub pboxmin_Click(sender As Object, e As EventArgs) Handles pboxmin.Click
        ...
        list1noty.Text = Name_of_list3
        list1noty.BalloonTipText = Name_of_list3 & " has been minimized"
    ...
    Private Sub btnback_Click(sender As Object, e As EventArgs) Handles btnback.Click
        ...
        list1noty.ShowBalloonTip(3000)
        frmtodoselect.Show()
        frmtodoselect.Button3.Visible = False
        frmtodoselect.lbllist3disabled.Visible = True
    End Sub
    Private Sub lsvTasks_SelectedIndexChanged(sender As Object, e As EventArgs) Handles lsvTasks.SelectedIndexChanged
        ...
        Next
    End Sub
    Private Sub Frmlist3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        List1.Text = Name_of_list3
